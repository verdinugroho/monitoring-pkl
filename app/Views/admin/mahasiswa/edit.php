...
<div class="container-fluid py-2">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            <form method="POST" action="/admin/mahasiswa/update/<?= $user['id'] ?>" class="row g-3">
                <?= csrf_field() ?>
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    ...
                    <input type="text" name="nim" id="nim" class="form-control" value="<?= old('nim', $user['nim']) ?>" required>
                </div>
