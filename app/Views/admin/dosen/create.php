...
<div class="container-fluid py-2">
    <div class="page-header">
        <div class="page-title">
            ...
            <div>
                ...
                <p class="text-muted small mb-0">Membuat akun dosen pembimbing baru untuk monitoring PKL.</p>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            <form method="POST" action="/admin/dosen/store" class="row g-3">
                <?= csrf_field() ?>

                <div class="col-lg-6 col-md-6 col-12">
                    <label class="form-label" for="nama">Nama Lengkap & Gelar</label>
                    <input type="text" name="nama" id="nama" class="form-control" placeholder="Dr. Budi Utomo, M.T." value="<?= old('nama') ?>" required>
                </div>

                <div class="col-lg-6 col-md-6 col-12">
                    <label class="form-label" for="nidn">Nomor Induk Dosen Nasional (NIDN)</label>
                    <input type="text" name="nidn" id="nidn" class="form-control" placeholder="0420088201" value="<?= old('nidn') ?>" required>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    ...
                    <input type="email" name="email" id="email" class="form-control" placeholder="dosen@domain.com" value="<?= old('email') ?>" required>
                </div>
                ...
                <div class="col-12 mt-4 text-end">
                    ...
                    <button type="submit" class="btn btn-primary px-4">Simpan Dosen</button>
                </div>
            </form>
        </div>
    </div>
